# Laborlauf 20260809-1429-3d28f24f
...
| Herkunft | Wert |
| --- | --: |
| gemessen am | 2026-08-09T14:29:28Z |
| Commit | `3d28f24fe4ff18b6e1edb63d366e2810ed078507` |
| Definitionstabelle | `0x6326FA3E56CFF5A3` |
| KI-Verhalten | `r5.779A1B5B` |
| Messgerät | `Schema 2` |
| Seed | `0xA17E57DE57` |
| Tickbudget | 27.000 |
| Slots | 2 |
| specVersion | 1 |
| Fingerabdruck | `543fb997a66ec8ba` |
...
| Rechenzeit | 864 ms | 6.682 Ticks/s |
...
| **late-push** | armySize 12→20; squadThreshold 6→12 | 50 % | 1/1/0 | 5.161 (-11 %) | 15.040 (-14 %) | 11 (+22 %) | 38 (+3 %) | 509 | 0 |
| **greedy-economy** | harvesters 2→4; armySize 12→16; squadThreshold 6→8 | 50 % | 1/1/0 | 4.290 (-26 %) | 22.835 (+30 %) | 8 (-11 %) | 31 (-16 %) | 467 | 0 |
...
| **wave-6** | waveSize 12→6 | 50 % | 1/1/0 | 10.702 (+85 %) | 31.255 (+78 %) | 7 (-22 %) | 86 (+132 %) | 1.115 | 0 |
| **wave-10** | waveSize 12→10 | 50 % | 1/1/0 | 5.218 (-10 %) | 15.685 (-10 %) | 7 (-22 %) | 29 (-22 %) | 486 | 0 |
| **wave-6-far** | waveSize 12→6; staging 12→70; stagingTol 4→6 | 50 % | 1/1/0 | 12.870 (+123 %) | 38.260 (+118 %) | 9 | 100 (+170 %) | 1.843 | 0 |
...
| **army-24** | armySize 12→24 | 50 % | 1/1/0 | 5.037 (-13 %) | 14.560 (-17 %) | 13 (+44 %) | 35 (-5 %) | 702 | 0 |
| **army-36** | armySize 12→36 | 50 % | 1/1/0 | 5.083 (-12 %) | 13.975 (-20 %) | 16 (+78 %) | 35 (-5 %) | 772 | 0 |
...
Nova.AiLab ist lokales Werkzeug, kein Beitrag — es gerät in keinen `feat/`-Branch und wird nie gemergt. Diese Ergebnismenge ist an Commit `3d28f24f` und Definitionstabelle `0x6326FA3E56CFF5A3` gebunden. Nach dem nächsten Merge-Fenster des Maintainers sind die Zahlen nicht mehr vergleichbar und werden neu vermessen, nicht über die Grenze hinweg verglichen.
